...
namespace move
{
	...
	///
	/////////////////////////////////////////////////////////////////////////////////////////////
	void getValidMovesPawn(const Color player, const PieceNode& piece, const ChessState& game, std::vector<Position>& moves)
	{
		Position forward;
		int originalRow;
	...
	std::vector<Move> getValidMoves(const ChessState& game, const Color player)
	{
		...
		const std::vector<PieceNode>& pieces = player == Color::WHITE ? game.getWhitePieces() : game.getBlackPieces();
		std::vector<Move> result = generatePawnMoves(game, player);
	...
	///
	/////////////////////////////////////////////////////////////////////////////////////////////
	bool isValidMove(const Color player, const PieceNode& piece, const Position& destination, const ChessState& game)
	{
	...
	///
	/////////////////////////////////////////////////////////////////////////////////////////////
	void makeMove(const Color player, const PieceNode& piece, const Position& destination, ChessState& game, const PieceType promotion)
	{
